...
public class OVRGrabber_DeadCOPY : MonoBehaviour
{
    ...
    //掴むときに使うボタン
    [SerializeField]
    protected OVRInput.Axis1D m_GripAxis1D = OVRInput.Axis1D.PrimaryHandTrigger;
    ...
    protected OVRGrabbable_DeadCOPY m_grabbedObj = null;
    protected Vector3 m_grabbedObjectPosOff;
    protected Quaternion m_grabbedObjectRotOff;
    protected Dictionary<OVRGrabbable_DeadCOPY, int> m_grabCandidates = new Dictionary<OVRGrabbable_DeadCOPY, int>();
    ...
    /// </summary>
    public OVRGrabbable_DeadCOPY grabbedObject
    {
        get { return m_grabbedObj; }
    }

    public void ForceRelease(OVRGrabbable_DeadCOPY grabbable)
    {
        bool canRelease = (
            (m_grabbedObj != null) &&
    ...
    void OnUpdatedAnchors()
    {
        ...
        m_prevFlex = OVRInput.Get(m_GripAxis1D, m_controller);//ここだぁ！
        //Debug.Log(ServerManager.ExWebSocketBehavior.ctrl[11].L2);
        m_prevFlex = (this.gameObject.tag == "lefthand") ? ServerManager.ExWebSocketBehavior.ctrl[this.num].L2 : ServerManager.ExWebSocketBehavior.ctrl[this.num].L1;
    ...
    void OnTriggerEnter(Collider otherCollider)
    {
        ...
        OVRGrabbable_DeadCOPY grabbable = otherCollider.GetComponent<OVRGrabbable_DeadCOPY>() ??
                                 otherCollider.GetComponentInParent<OVRGrabbable_DeadCOPY>();
    ...
    protected virtual void GrabBegin()
    {
        ...
        OVRGrabbable_DeadCOPY closestGrabbable = null;
        Collider closestGrabbableCollider = null;

        // Iterate grab candidates and find the closest grabbable candidate
        foreach (OVRGrabbable_DeadCOPY grabbable in m_grabCandidates.Keys)
        {
    ...
    protected virtual void OffhandGrabbed(OVRGrabbable_DeadCOPY grabbable)
    {
