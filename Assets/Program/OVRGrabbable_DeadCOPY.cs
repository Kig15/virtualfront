...
public class OVRGrabbable_DeadCOPY : MonoBehaviour
{
    [SerializeField]
    ...
    protected OVRGrabber_DeadCOPY m_grabbedBy = null;
    ...
    /// </summary>
    public OVRGrabber_DeadCOPY grabbedBy
    {
    ...
    /// </summary>
    virtual public void GrabBegin(OVRGrabber_DeadCOPY hand, Collider grabPoint)
    {
        m_grabbedBy = hand;
