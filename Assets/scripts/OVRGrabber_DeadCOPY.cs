...
public class OVRGrabber_DeadCOPY : MonoBehaviour
{
    ...
    void OnUpdatedAnchors()
    {
        ...
        // m_prevFlex = OVRInput.Get(m_GripAxis1D, m_controller);//?��?��?��?��?��?��?��?��?��I
        // m_prevFlex = ServerManager.ExWebSocketBehavior.ctrl.a ? 1 : 0;
        m_prevFlex = ServerManager.ExWebSocketBehavior.ctrl[0].a ? 1 : 0;

        // Debug.Log(ServerManager.ExWebSocketBehavior.ctrl.a);
